...
class Metaclass_GetTaskGroup_Request(type):
    """Metaclass of message 'GetTaskGroup_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_task_group__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_task_group__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_task_group__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_task_group__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_task_group__request
...
class GetTaskGroup_Request(metaclass=Metaclass_GetTaskGroup_Request):
    """Message class 'GetTaskGroup_Request'."""
...
class Metaclass_GetTaskGroup_Response(type):
    """Metaclass of message 'GetTaskGroup_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_task_group__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_task_group__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_task_group__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_task_group__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_task_group__response
    ...
    def ERROR_NONE(self):
        ...
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_NONE']

    @property
    def ERROR_INVALID_REQUEST(self):
        """Message constant 'ERROR_INVALID_REQUEST'."""
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_INVALID_REQUEST']

    @property
    def ERROR_NOT_FOUND(self):
        """Message constant 'ERROR_NOT_FOUND'."""
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_NOT_FOUND']

    @property
    def ERROR_REVISION_CONFLICT(self):
        """Message constant 'ERROR_REVISION_CONFLICT'."""
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_REVISION_CONFLICT']

    @property
    def ERROR_SCHEMA_INVALID(self):
        """Message constant 'ERROR_SCHEMA_INVALID'."""
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_SCHEMA_INVALID']

    @property
    def ERROR_INTERNAL(self):
        """Message constant 'ERROR_INTERNAL'."""
        return Metaclass_GetTaskGroup_Response.__constants['ERROR_INTERNAL']


class GetTaskGroup_Response(metaclass=Metaclass_GetTaskGroup_Response):
    """
    Message class 'GetTaskGroup_Response'.
...
class Metaclass_GetTaskGroup(type):
    """Metaclass of service 'GetTaskGroup'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.srv.GetTaskGroup')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__get_task_group

            from agt_interfaces.srv import _get_task_group
            if _get_task_group.Metaclass_GetTaskGroup_Request._TYPE_SUPPORT is None:
                _get_task_group.Metaclass_GetTaskGroup_Request.__import_type_support__()
            if _get_task_group.Metaclass_GetTaskGroup_Response._TYPE_SUPPORT is None:
                _get_task_group.Metaclass_GetTaskGroup_Response.__import_type_support__()


class GetTaskGroup(metaclass=Metaclass_GetTaskGroup):
    from agt_interfaces.srv._get_task_group import GetTaskGroup_Request as Request
    from agt_interfaces.srv._get_task_group import GetTaskGroup_Response as Response
