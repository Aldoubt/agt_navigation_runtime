...
bool agt_interfaces__srv__activate_map_version__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._activate_map_version.ActivateMapVersion_Request", full_classname_dest, 67) == 0);
  }
  agt_interfaces__srv__ActivateMapVersion_Request * ros_message = _ros_message;
  {  // map_id
...
{
  /* NOTE(esteve): Call constructor of ActivateMapVersion_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._activate_map_version");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActivateMapVersion_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool agt_interfaces__srv__activate_map_version__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._activate_map_version.ActivateMapVersion_Response", full_classname_dest, 68) == 0);
  }
  agt_interfaces__srv__ActivateMapVersion_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // operator_messages
    PyObject * field = PyObject_GetAttrString(_pymsg, "operator_messages");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'operator_messages'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      if (!rosidl_runtime_c__String__Sequence__init(&(ros_message->operator_messages), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
      rosidl_runtime_c__String * dest = ros_message->operator_messages.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // technical_messages
    PyObject * field = PyObject_GetAttrString(_pymsg, "technical_messages");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'technical_messages'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      if (!rosidl_runtime_c__String__Sequence__init(&(ros_message->technical_messages), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
      rosidl_runtime_c__String * dest = ros_message->technical_messages.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of ActivateMapVersion_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._activate_map_version");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActivateMapVersion_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // operator_messages
    PyObject * field = NULL;
    size_t size = ros_message->operator_messages.size;
    rosidl_runtime_c__String * src = ros_message->operator_messages.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "operator_messages", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // technical_messages
    PyObject * field = NULL;
    size_t size = ros_message->technical_messages.size;
    rosidl_runtime_c__String * src = ros_message->technical_messages.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "technical_messages", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
