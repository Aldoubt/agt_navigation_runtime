...
class GetRobotState_Request(metaclass=Metaclass_GetRobotState_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.include_details = kwargs.get('include_details', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.include_details != other.include_details:
            return False
        return True
    ...
    def include_details(self):
        """Message field 'include_details'."""
        return self._include_details

    @include_details.setter
    def include_details(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'include_details' field must be of type 'bool'"
        self._include_details = value
...
class GetRobotState_Response(metaclass=Metaclass_GetRobotState_Response):
    ...
    _fields_and_field_types = {
        'success': 'boolean',
        'error_code': 'uint16',
        'state': 'agt_interfaces/RobotState',
        'message': 'string',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['agt_interfaces', 'msg'], 'RobotState'),  # noqa: E501
...
class Metaclass_GetRobotState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from agt_interfaces.srv import _get_robot_state
...
class GetRobotState(metaclass=Metaclass_GetRobotState):
    from agt_interfaces.srv._get_robot_state import GetRobotState_Request as Request
    from agt_interfaces.srv._get_robot_state import GetRobotState_Response as Response
