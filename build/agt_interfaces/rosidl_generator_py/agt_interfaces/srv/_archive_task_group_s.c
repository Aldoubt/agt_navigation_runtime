...
bool agt_interfaces__srv__archive_task_group__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._archive_task_group.ArchiveTaskGroup_Request", full_classname_dest, 63) == 0);
  }
  agt_interfaces__srv__ArchiveTaskGroup_Request * ros_message = _ros_message;
  {  // map_id
  ...
  {  // expected_revision
    PyObject * field = PyObject_GetAttrString(_pymsg, "expected_revision");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->expected_revision = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // client_request_id
...
{
  /* NOTE(esteve): Call constructor of ArchiveTaskGroup_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._archive_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArchiveTaskGroup_Request");
  ...
  {  // expected_revision
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->expected_revision);
    {
      int rc = PyObject_SetAttrString(_pymessage, "expected_revision", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool agt_interfaces__srv__archive_task_group__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._archive_task_group.ArchiveTaskGroup_Response", full_classname_dest, 64) == 0);
  }
  agt_interfaces__srv__ArchiveTaskGroup_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // archived_revision
    PyObject * field = PyObject_GetAttrString(_pymsg, "archived_revision");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->archived_revision = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // archived_relative_path
    PyObject * field = PyObject_GetAttrString(_pymsg, "archived_relative_path");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->archived_relative_path, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ArchiveTaskGroup_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._archive_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArchiveTaskGroup_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // archived_revision
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->archived_revision);
    {
      int rc = PyObject_SetAttrString(_pymessage, "archived_revision", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // archived_relative_path
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->archived_relative_path.data,
      strlen(ros_message->archived_relative_path.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "archived_relative_path", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
