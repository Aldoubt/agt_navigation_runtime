...
bool agt_interfaces__srv__get_task_group__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._get_task_group.GetTaskGroup_Request", full_classname_dest, 55) == 0);
  }
  agt_interfaces__srv__GetTaskGroup_Request * ros_message = _ros_message;
  {  // map_id
...
{
  /* NOTE(esteve): Call constructor of GetTaskGroup_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._get_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTaskGroup_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool agt_interfaces__srv__get_task_group__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._get_task_group.GetTaskGroup_Response", full_classname_dest, 56) == 0);
  }
  agt_interfaces__srv__GetTaskGroup_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of GetTaskGroup_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._get_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTaskGroup_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
