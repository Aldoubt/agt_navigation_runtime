...
bool agt_interfaces__srv__put_task_group__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._put_task_group.PutTaskGroup_Request", full_classname_dest, 55) == 0);
  }
  agt_interfaces__srv__PutTaskGroup_Request * ros_message = _ros_message;
  {  // map_id
  ...
  {  // task_json
    PyObject * field = PyObject_GetAttrString(_pymsg, "task_json");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->task_json, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PutTaskGroup_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._put_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PutTaskGroup_Request");
  ...
  {  // task_json
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->task_json.data,
      strlen(ros_message->task_json.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "task_json", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool agt_interfaces__srv__put_task_group__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agt_interfaces.srv._put_task_group.PutTaskGroup_Response", full_classname_dest, 56) == 0);
  }
  agt_interfaces__srv__PutTaskGroup_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // revision
    ...
    assert(PyLong_Check(field));
    ros_message->revision = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // content_sha256
...
{
  /* NOTE(esteve): Call constructor of PutTaskGroup_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agt_interfaces.srv._put_task_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PutTaskGroup_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
