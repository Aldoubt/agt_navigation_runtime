    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_Goal')
            logger.debug(
...
class Metaclass_ExecuteMission_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_Result(metaclass=Metaclass_ExecuteMission_Result):
    ...
    _fields_and_field_types = {
        'success': 'boolean',
        'error_code': 'uint16',
        'final_status': 'agt_interfaces/MissionStatus',
    ...
    def __init__(self, **kwargs):
        ...
        from agt_interfaces.msg import MissionStatus
        self.final_status = kwargs.get('final_status', MissionStatus())
        self.audit_log_uri = kwargs.get('audit_log_uri', str())
    ...
    def __eq__(self, other):
        ...
        if self.final_status != other.final_status:
            return False
        if self.audit_log_uri != other.audit_log_uri:
            return False
    ...
    def final_status(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'final_status' field must be a sub message of type 'MissionStatus'"
        self._final_status = value

    @builtins.property
    def audit_log_uri(self):
        """Message field 'audit_log_uri'."""
        return self._audit_log_uri

    @audit_log_uri.setter
    def audit_log_uri(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'audit_log_uri' field must be of type 'str'"
        self._audit_log_uri = value
...
class Metaclass_ExecuteMission_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_SendGoal_Request(metaclass=Metaclass_ExecuteMission_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'agt_interfaces/ExecuteMission_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['agt_interfaces', 'action'], 'ExecuteMission_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from agt_interfaces.action._execute_mission import ExecuteMission_Goal
...
class Metaclass_ExecuteMission_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from agt_interfaces.action import _execute_mission
...
class ExecuteMission_SendGoal(metaclass=Metaclass_ExecuteMission_SendGoal):
    from agt_interfaces.action._execute_mission import ExecuteMission_SendGoal_Request as Request
    from agt_interfaces.action._execute_mission import ExecuteMission_SendGoal_Response as Response
...
class ExecuteMission_GetResult_Response(metaclass=Metaclass_ExecuteMission_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'agt_interfaces/ExecuteMission_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['agt_interfaces', 'action'], 'ExecuteMission_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from agt_interfaces.action._execute_mission import ExecuteMission_Result
...
class Metaclass_ExecuteMission_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_GetResult(metaclass=Metaclass_ExecuteMission_GetResult):
    from agt_interfaces.action._execute_mission import ExecuteMission_GetResult_Request as Request
    from agt_interfaces.action._execute_mission import ExecuteMission_GetResult_Response as Response
...
class Metaclass_ExecuteMission_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agt_interfaces.action.ExecuteMission_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_FeedbackMessage(metaclass=Metaclass_ExecuteMission_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'agt_interfaces/ExecuteMission_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['agt_interfaces', 'action'], 'ExecuteMission_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from agt_interfaces.action._execute_mission import ExecuteMission_Feedback
...
class ExecuteMission(metaclass=Metaclass_ExecuteMission):
    ...
    from agt_interfaces.action._execute_mission import ExecuteMission_Goal as Goal
    # The result message defined in the action definition.
    from agt_interfaces.action._execute_mission import ExecuteMission_Result as Result
    # The feedback message defined in the action definition.
    from agt_interfaces.action._execute_mission import ExecuteMission_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from agt_interfaces.action._execute_mission import ExecuteMission_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from agt_interfaces.action._execute_mission import ExecuteMission_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from agt_interfaces.action._execute_mission import ExecuteMission_FeedbackMessage as FeedbackMessage
