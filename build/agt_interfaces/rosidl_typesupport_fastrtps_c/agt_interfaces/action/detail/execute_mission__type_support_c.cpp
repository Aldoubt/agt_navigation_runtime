...
#include "agt_interfaces/action/detail/execute_mission__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // expected_content_sha256, mission_id, mission_version
#include "rosidl_runtime_c/string_functions.h"  // expected_content_sha256, mission_id, mission_version

// forward declare type support functions


using _ExecuteMission_Goal__ros_msg_type = agt_interfaces__action__ExecuteMission_Goal;
...
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
  const void * untyped_ros_message,
...
static uint32_t _ExecuteMission_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agt_interfaces__action__ExecuteMission_Goal;
    is_plain =
      (
      offsetof(DataType, expected_content_sha256) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ExecuteMission_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Goal)() {
...
#include "agt_interfaces/msg/detail/mission_status__functions.h"  // final_status
// already included above
// #include "rosidl_runtime_c/string.h"  // audit_log_uri, message
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // audit_log_uri, message
...
using _ExecuteMission_Result__ros_msg_type = agt_interfaces__action__ExecuteMission_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: audit_log_uri
  {
    const rosidl_runtime_c__String * str = &ros_message->audit_log_uri;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: audit_log_uri
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->audit_log_uri.data) {
      rosidl_runtime_c__String__init(&ros_message->audit_log_uri);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->audit_log_uri,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'audit_log_uri'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_Result__ros_msg_type * ros_message = static_cast<const _ExecuteMission_Result__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->audit_log_uri.size + 1);
  // field.name message
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_Result;
    is_plain =
      (
...
static size_t _ExecuteMission_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Result)() {
...
// already included above
// #include "agt_interfaces/msg/detail/mission_status__functions.h"  // status
...
using _ExecuteMission_Feedback__ros_msg_type = agt_interfaces__action__ExecuteMission_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_Feedback__ros_msg_type * ros_message = static_cast<const _ExecuteMission_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_Feedback;
    is_plain =
      (
...
static size_t _ExecuteMission_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Feedback)() {
...
// already included above
// #include "agt_interfaces/action/detail/execute_mission__functions.h"  // goal
...
using _ExecuteMission_SendGoal_Request__ros_msg_type = agt_interfaces__action__ExecuteMission_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ExecuteMission_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_agt_interfaces__action__ExecuteMission_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecuteMission_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_SendGoal_Request)() {
...
using _ExecuteMission_SendGoal_Response__ros_msg_type = agt_interfaces__action__ExecuteMission_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ExecuteMission_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecuteMission_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_SendGoal)() {
...
using _ExecuteMission_GetResult_Request__ros_msg_type = agt_interfaces__action__ExecuteMission_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ExecuteMission_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecuteMission_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_GetResult_Request)() {
...
// already included above
// #include "agt_interfaces/action/detail/execute_mission__functions.h"  // result
...
using _ExecuteMission_GetResult_Response__ros_msg_type = agt_interfaces__action__ExecuteMission_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ExecuteMission_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_agt_interfaces__action__ExecuteMission_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_agt_interfaces__action__ExecuteMission_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecuteMission_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_GetResult)() {
...
// already included above
// #include "agt_interfaces/action/detail/execute_mission__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ExecuteMission_FeedbackMessage__ros_msg_type = agt_interfaces__action__ExecuteMission_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t get_serialized_size_agt_interfaces__action__ExecuteMission_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ExecuteMission_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__action__ExecuteMission_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agt_interfaces
size_t max_serialized_size_agt_interfaces__action__ExecuteMission_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_agt_interfaces__action__ExecuteMission_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__action__ExecuteMission_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecuteMission_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__action__ExecuteMission_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, action, ExecuteMission_FeedbackMessage)() {
