...
#include "agt_interfaces/msg/detail/system_health__rosidl_typesupport_fastrtps_c.h"
...
#include "agt_interfaces/msg/detail/component_health__functions.h"  // components
#include "rosidl_runtime_c/string.h"  // blocker_codes, blocker_messages, warning_codes, warning_messages
#include "rosidl_runtime_c/string_functions.h"  // blocker_codes, blocker_messages, warning_codes, warning_messages
...
using _SystemHealth__ros_msg_type = agt_interfaces__msg__SystemHealth;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: components
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, agt_interfaces, msg, ComponentHealth
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _SystemHealth__ros_msg_type * ros_message = static_cast<_SystemHealth__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: components
  {
    ...
    if (ros_message->components.data) {
      agt_interfaces__msg__ComponentHealth__Sequence__fini(&ros_message->components);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name components
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_agt_interfaces__msg__ComponentHealth(
...
static uint32_t _SystemHealth__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__msg__SystemHealth(
  ...
  size_t current_alignment)
{
  ...
  // member: components
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_agt_interfaces__msg__ComponentHealth(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = agt_interfaces__msg__SystemHealth;
    is_plain =
      (
...
static size_t _SystemHealth__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__msg__SystemHealth(
