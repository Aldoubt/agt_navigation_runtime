...
#include "agt_interfaces/srv/detail/get_robot_state__rosidl_typesupport_fastrtps_c.h"
...
using _GetRobotState_Request__ros_msg_type = agt_interfaces__srv__GetRobotState_Request;
...
static uint32_t _GetRobotState_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__srv__GetRobotState_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agt_interfaces__srv__GetRobotState_Request;
    is_plain =
      (
...
static size_t _GetRobotState_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__srv__GetRobotState_Request(
...
#include "agt_interfaces/msg/detail/robot_state__functions.h"  // state
...
using _GetRobotState_Response__ros_msg_type = agt_interfaces__srv__GetRobotState_Response;
  ...
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, agt_interfaces, msg, RobotState
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_agt_interfaces__msg__RobotState(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agt_interfaces__srv__GetRobotState_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_agt_interfaces__msg__RobotState(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agt_interfaces__srv__GetRobotState_Response;
    is_plain =
      (
...
static size_t _GetRobotState_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agt_interfaces__srv__GetRobotState_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "agt_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "agt_interfaces/srv/get_robot_state.h"
