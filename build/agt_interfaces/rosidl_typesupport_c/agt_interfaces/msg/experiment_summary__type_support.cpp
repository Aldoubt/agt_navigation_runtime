...
static const _ExperimentSummary_type_support_symbol_names_t _ExperimentSummary_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, msg, ExperimentSummary)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, msg, ExperimentSummary)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, msg, ExperimentSummary)() {
  return &::agt_interfaces::msg::rosidl_typesupport_c::ExperimentSummary_message_type_support_handle;
}
