...
static const _ArchiveTaskGroup_Request_type_support_symbol_names_t _ArchiveTaskGroup_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, ArchiveTaskGroup_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, ArchiveTaskGroup_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, ArchiveTaskGroup_Request)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::ArchiveTaskGroup_Request_message_type_support_handle;
}
...
static const _ArchiveTaskGroup_Response_type_support_symbol_names_t _ArchiveTaskGroup_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, ArchiveTaskGroup_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, ArchiveTaskGroup_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, ArchiveTaskGroup_Response)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::ArchiveTaskGroup_Response_message_type_support_handle;
}
...
static const _ArchiveTaskGroup_type_support_symbol_names_t _ArchiveTaskGroup_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, ArchiveTaskGroup)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, ArchiveTaskGroup)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, ArchiveTaskGroup)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::ArchiveTaskGroup_service_type_support_handle;
}
