...
static const _SetLocalizationMode_Request_type_support_symbol_names_t _SetLocalizationMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, SetLocalizationMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, SetLocalizationMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, SetLocalizationMode_Request)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::SetLocalizationMode_Request_message_type_support_handle;
}
...
static const _SetLocalizationMode_Response_type_support_symbol_names_t _SetLocalizationMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, SetLocalizationMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, SetLocalizationMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, SetLocalizationMode_Response)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::SetLocalizationMode_Response_message_type_support_handle;
}
...
static const _SetLocalizationMode_type_support_symbol_names_t _SetLocalizationMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agt_interfaces, srv, SetLocalizationMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agt_interfaces, srv, SetLocalizationMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, agt_interfaces, srv, SetLocalizationMode)() {
  return &::agt_interfaces::srv::rosidl_typesupport_c::SetLocalizationMode_service_type_support_handle;
}
