...
#include "agt_interfaces/msg/detail/semantic_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agt_interfaces::msg::SemanticWaypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agt_interfaces::msg::SemanticWaypoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agt_interfaces::msg::SemanticWaypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agt_interfaces::msg::SemanticWaypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agt_interfaces::msg::SemanticWaypoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SemanticWaypoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const agt_interfaces::msg::SemanticWaypoint *>(
...
static size_t _SemanticWaypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SemanticWaypoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SemanticWaypoint__callbacks = {
  "agt_interfaces::msg",
  "SemanticWaypoint",
...
static rosidl_message_type_support_t _SemanticWaypoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SemanticWaypoint__callbacks,
...
{
  return &agt_interfaces::msg::typesupport_fastrtps_cpp::_SemanticWaypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agt_interfaces, msg, SemanticWaypoint)() {
  return &agt_interfaces::msg::typesupport_fastrtps_cpp::_SemanticWaypoint__handle;
}
