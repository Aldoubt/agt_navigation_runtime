...
#include "agt_interfaces/msg/detail/task_readiness__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agt_interfaces::msg::TaskReadiness & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.localization_state;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agt_interfaces::msg::TaskReadiness & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agt_interfaces::msg::TaskReadiness;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agt_interfaces::msg::TaskReadiness *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agt_interfaces::msg::TaskReadiness *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskReadiness__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const agt_interfaces::msg::TaskReadiness *>(
...
static size_t _TaskReadiness__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskReadiness(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TaskReadiness__callbacks = {
  "agt_interfaces::msg",
  "TaskReadiness",
...
static rosidl_message_type_support_t _TaskReadiness__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TaskReadiness__callbacks,
...
{
  return &agt_interfaces::msg::typesupport_fastrtps_cpp::_TaskReadiness__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agt_interfaces, msg, TaskReadiness)() {
  return &agt_interfaces::msg::typesupport_fastrtps_cpp::_TaskReadiness__handle;
}
