...
#ifndef AGT_INTERFACES__SRV__DETAIL__LIST_BAG_SESSIONS__FUNCTIONS_H_
#define AGT_INTERFACES__SRV__DETAIL__LIST_BAG_SESSIONS__FUNCTIONS_H_
...
/// Initialize srv/ListBagSessions message.
/**
...
/// Finalize srv/ListBagSessions message.
/**
...
/// Create srv/ListBagSessions message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * agt_interfaces__srv__ListBagSessions_Request__init().
...
/// Destroy srv/ListBagSessions message.
/**
 * It calls
 * agt_interfaces__srv__ListBagSessions_Request__fini()
...
/// Check for srv/ListBagSessions message equality.
/**
...
/// Copy a srv/ListBagSessions message.
/**
...
/// Initialize array of srv/ListBagSessions messages.
/**
...
/// Finalize array of srv/ListBagSessions messages.
/**
 * It calls
 * agt_interfaces__srv__ListBagSessions_Request__fini()
...
/// Create array of srv/ListBagSessions messages.
/**
 * It allocates the memory for the array and calls
 * agt_interfaces__srv__ListBagSessions_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ListBagSessions messages.
/**
 * It calls
 * agt_interfaces__srv__ListBagSessions_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ListBagSessions message array equality.
/**
...
/// Copy an array of srv/ListBagSessions messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * agt_interfaces__srv__ListBagSessions_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_agt_interfaces
...
/**
 * It calls
 * agt_interfaces__srv__ListBagSessions_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_agt_interfaces
...
/**
 * It allocates the memory for the array and calls
 * agt_interfaces__srv__ListBagSessions_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_agt_interfaces
...
/**
 * It calls
 * agt_interfaces__srv__ListBagSessions_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AGT_INTERFACES__SRV__DETAIL__LIST_BAG_SESSIONS__FUNCTIONS_H_
