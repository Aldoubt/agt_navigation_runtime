...
foreach(_expectedTarget ndt_omp_ros2::ndt_omp)
...
# Create imported target ndt_omp_ros2::ndt_omp
add_library(ndt_omp_ros2::ndt_omp STATIC IMPORTED)

set_target_properties(ndt_omp_ros2::ndt_omp PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/usr/include/pcl-1.12;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2"
...
file(GLOB CONFIG_FILES "${_DIR}/export_ndt_omp_ros2Export-*.cmake")
