...
: ${AMENT_CURRENT_PREFIX:="/home/yangxuan/agt_navigation_runtime/install/ndt_omp_ros2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ndt_omp_ros2/environment/library_path.sh"
