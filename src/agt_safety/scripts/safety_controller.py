...
def sensor_summary_is_ready(
    ...
    None means this array did not contain the configured summary and therefore
    must not refresh the safety freshness timer.
    """
...
class SafetyController(Node):
    def __init__(self) -> None:
        super().__init__("agt_safety_controller")
        ...
        self.create_service(
            Trigger,
            "/agt/safety/reset_emergency_stop",
            self._reset_estop,
            callback_group=service_group,
        )
