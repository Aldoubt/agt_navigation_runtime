...
def _counter_deltas(
    ...
    deltas: dict[str, int] = {}
    blockers: list[str] = []
    for field in _OBSERVED_COUNTERS:
...
def run_preflight(
    ...
    *,
    ...
    it synchronously before composing drivers.  The CLI opts into a time
    window by default so field acceptance can detect newly accumulating bus
    errors.
    """
