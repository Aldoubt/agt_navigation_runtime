      ...
      OneValue(kGlobalCostMap, ) OneValue(kRobotPose, ) OneValue(kLaserScan, ) \
          OneValue(kLocalPath, ) OneValue(kGlobalPath, ) OneValue(kOdomPose, ) \
              OneValue(kSetNavGoalPose, ) OneValue(kSetRelocPose, )            \
                  ...
                  OneValue(kTaskChain, ) OneValue(kTaskCancel, ) OneValue(kTaskStatus, )
...
#define MSG_ID_TASK_CHAIN ToString(MsgId::kTaskChain)
#define MSG_ID_TASK_CANCEL ToString(MsgId::kTaskCancel)
#define MSG_ID_TASK_STATUS ToString(MsgId::kTaskStatus)
