...
class rclcomm : public VirtualChannelNode {
 ...
 private:
  ...
  void hmiTaskStatusCallback(const std_msgs::msg::String::SharedPtr msg);
 ...
 public:
  ...
  void PubHmiTaskChain(const std::string &json);
  void CancelHmiTaskChain();
 ...
 private:
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr hmi_task_chain_publisher_;
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr hmi_task_cancel_publisher_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr hmi_task_status_subscriber_;
